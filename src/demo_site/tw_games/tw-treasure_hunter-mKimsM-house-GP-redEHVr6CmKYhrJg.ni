...
Test quest0_0 with "go south / go west / go south / go east / take carrot"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing session of TextWorld! Here is how to play! Your first objective is to attempt to move south. Then, attempt to head west. After that, attempt to take a trip south. W".
The objective part 1 is some text that varies. The objective part 1 is "ith that accomplished, try to take a trip east. And then, pick up the carrot from the floor of the bedchamber. Got that? Good!".
